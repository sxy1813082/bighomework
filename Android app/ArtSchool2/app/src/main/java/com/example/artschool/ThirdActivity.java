...
public class ThirdActivity extends AppCompatActivity {
    ...
    public void initData() {
        ...
        int[] imageRess = new int[]{R.drawable.image_art,R.drawable.image_art2,R.drawable.image_art3,R.drawable.donut_circle};
    ...
    private class pagerImageOnClick implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.image_art:
                    Toast.makeText(ThirdActivity.this, "图片1被点击", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.image_art2:
                    Toast.makeText(ThirdActivity.this, "图片2被点击", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.image_art3:
                    Toast.makeText(ThirdActivity.this, "图片3被点击", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.donut_circle:
                    Toast.makeText(ThirdActivity.this, "图片4被点击", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    }
